...
class CarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.seller.car.index', compact('carLists'));
    }
    ...
    {
        return view('admin.seller.car.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($insert->save()) {
            ...
            if ($update->save()) {
                return redirect('seller/car')->with('success', 'Data Successfully Added');
            } else {
                return redirect('seller/car')->with('error', 'Data Successfully Added But Images Or Videos Not Added');
            }

        } else {
            return redirect('seller/car/create')->with('error', 'Data Not Successfully Added ');
        }
    ...
    public function show($id)
    {
        ...
        return view('admin.seller.car.detail', compact('carList'));
    }
    ...
    public function car_request($id)
    {
        $car = CarPost::find($id);
        $car->is_request = true;
        $car->save();
        return back()->with('message', 'Request has been Sent to the Admin');
    }
